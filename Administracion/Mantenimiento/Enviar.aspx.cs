...
public partial class Administracion_Mantenimiento_Enviar : System.Web.UI.Page
{
    public int id
    {
        get
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                this.id = Int32.Parse(Util.GetCookieValue(cookiesNombre.cookieEnvio));
    ...
    protected void btnGuardar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (mantenimiento.indicarEnvio(fecha, this.id))
        {
