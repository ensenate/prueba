...
<ContentTemplate>
        ...
        <asp:LinkButton ID="lnkInventario" runat="server" 
            OnClick="ver_articulos_Click">Articulo</asp:LinkButton>
        ...
        <asp:LinkButton ID="lnkMantenimiento" runat="server" PostBackUrl="~/Administracion/Mantenimiento/Default.aspx" >Mantenimiento</asp:LinkButton>
        
        <asp:LinkButton ID="LnkReportes" runat="server" PostBackUrl="~/Reportes/Default.aspx"  >Reportes</asp:LinkButton>
