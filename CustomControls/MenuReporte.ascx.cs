...
public partial class CustomControls_MenuReporteç : System.Web.UI.UserControl
{
    ...
    {
        this.Page.Response.Redirect("~/Reportes/VerReporte.aspx?r=1");
    }
    ...
    protected void LnkArticulos(object sender, EventArgs e)
    {
        this.Page.Response.Redirect("~/Reportes/VerReporte.aspx?r=3");
    }
    ...
    // modulo de impresion de reportes
    protected void LnkImprimirReportes(object sender, EventArgs e)
    {
        //se va a comentar para hacer la pagina de busqueda de reportes
        //buscar(sender, e);

      this.Page.Response.Redirect("~/Reportes/ImprimirReportes/Default.aspx");
       

    }


    //codgio para hacer el reporte y la llamada para mostrarlo
    protected void buscar(object sender, EventArgs e){
        ...
        //Response.WriteFile(Server.MapPath(Path.Combine("~/files", ruta)));
        //Response.End();
